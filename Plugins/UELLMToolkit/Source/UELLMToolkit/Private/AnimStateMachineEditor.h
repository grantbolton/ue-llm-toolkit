...
public:
	...
	/**
	 * Create a new state machine in a specific animation graph (e.g., layer function graph)
	 * @param AnimBP - Animation Blueprint (for marking dirty)
	 * @param TargetGraph - The animation graph to create the SM in
	 * @param StateMachineName - Name for the state machine
