...
private:
	...
	static UEdGraphNode* CreateTwoBoneIKNode(UEdGraph* Graph, const FString& BoneName, const TSharedPtr<FJsonObject>& Params, int32 PosX, int32 PosY, FString& OutError);
	static UEdGraphNode* CreateControlRigNode(UEdGraph* Graph, const FString& ControlRigClass, const TSharedPtr<FJsonObject>& Params, int32 PosX, int32 PosY, FString& OutError);
