...
{
	static TMap<FString, FString> KeyAliases;
	if (KeyAliases.Num() == 0)
	{
		KeyAliases.Add(TEXT("R3"), TEXT("Gamepad_RightThumbstick"));
		KeyAliases.Add(TEXT("L3"), TEXT("Gamepad_LeftThumbstick"));
		KeyAliases.Add(TEXT("R1"), TEXT("Gamepad_RightShoulder"));
		KeyAliases.Add(TEXT("L1"), TEXT("Gamepad_LeftShoulder"));
		KeyAliases.Add(TEXT("RB"), TEXT("Gamepad_RightShoulder"));
		KeyAliases.Add(TEXT("LB"), TEXT("Gamepad_LeftShoulder"));
		KeyAliases.Add(TEXT("R2"), TEXT("Gamepad_RightTrigger"));
		KeyAliases.Add(TEXT("L2"), TEXT("Gamepad_LeftTrigger"));
		KeyAliases.Add(TEXT("RT"), TEXT("Gamepad_RightTrigger"));
		KeyAliases.Add(TEXT("LT"), TEXT("Gamepad_LeftTrigger"));
		KeyAliases.Add(TEXT("R2Axis"), TEXT("Gamepad_RightTriggerAxis"));
		KeyAliases.Add(TEXT("L2Axis"), TEXT("Gamepad_LeftTriggerAxis"));
		KeyAliases.Add(TEXT("RTAxis"), TEXT("Gamepad_RightTriggerAxis"));
		KeyAliases.Add(TEXT("LTAxis"), TEXT("Gamepad_LeftTriggerAxis"));
		KeyAliases.Add(TEXT("Cross"), TEXT("Gamepad_FaceButton_Bottom"));
		KeyAliases.Add(TEXT("Circle"), TEXT("Gamepad_FaceButton_Right"));
		KeyAliases.Add(TEXT("Square"), TEXT("Gamepad_FaceButton_Left"));
		KeyAliases.Add(TEXT("Triangle"), TEXT("Gamepad_FaceButton_Top"));
		KeyAliases.Add(TEXT("FaceA"), TEXT("Gamepad_FaceButton_Bottom"));
		KeyAliases.Add(TEXT("FaceB"), TEXT("Gamepad_FaceButton_Right"));
		KeyAliases.Add(TEXT("FaceX"), TEXT("Gamepad_FaceButton_Left"));
		KeyAliases.Add(TEXT("FaceY"), TEXT("Gamepad_FaceButton_Top"));
		KeyAliases.Add(TEXT("LeftStickX"), TEXT("Gamepad_LeftX"));
		KeyAliases.Add(TEXT("LeftStickY"), TEXT("Gamepad_LeftY"));
		KeyAliases.Add(TEXT("RightStickX"), TEXT("Gamepad_RightX"));
		KeyAliases.Add(TEXT("RightStickY"), TEXT("Gamepad_RightY"));
		KeyAliases.Add(TEXT("LeftStick2D"), TEXT("Gamepad_Left2D"));
		KeyAliases.Add(TEXT("RightStick2D"), TEXT("Gamepad_Right2D"));
		KeyAliases.Add(TEXT("DPadUp"), TEXT("Gamepad_DPad_Up"));
		KeyAliases.Add(TEXT("DPadDown"), TEXT("Gamepad_DPad_Down"));
		KeyAliases.Add(TEXT("DPadLeft"), TEXT("Gamepad_DPad_Left"));
		KeyAliases.Add(TEXT("DPadRight"), TEXT("Gamepad_DPad_Right"));
		KeyAliases.Add(TEXT("Start"), TEXT("Gamepad_Special_Right"));
		KeyAliases.Add(TEXT("Select"), TEXT("Gamepad_Special_Left"));
		KeyAliases.Add(TEXT("Options"), TEXT("Gamepad_Special_Right"));
		KeyAliases.Add(TEXT("Share"), TEXT("Gamepad_Special_Left"));
		KeyAliases.Add(TEXT("Menu"), TEXT("Gamepad_Special_Right"));
		KeyAliases.Add(TEXT("View"), TEXT("Gamepad_Special_Left"));
		KeyAliases.Add(TEXT("LMB"), TEXT("LeftMouseButton"));
		KeyAliases.Add(TEXT("RMB"), TEXT("RightMouseButton"));
		KeyAliases.Add(TEXT("MMB"), TEXT("MiddleMouseButton"));
	}

	FString ResolvedName = KeyName;
	if (const FString* Alias = KeyAliases.Find(KeyName))
	{
		ResolvedName = *Alias;
	}

	FKey ParsedKey = FKey(*ResolvedName);

	if (!ParsedKey.IsValid())
	{
		OutError = FString::Printf(
			TEXT("Invalid key name: %s. Use standard UE key names (e.g., 'SpaceBar', 'Gamepad_FaceButton_Bottom') or aliases (R3, L3, R1, L1, R2, L2, RB, LB, RT, LT, Cross, Circle, Square, Triangle, LMB, RMB)"),
			*KeyName);
		return FKey();
	}
