...
public:
	virtual FMCPToolInfo GetInfo() const override
	{
		...
		Info.Description = TEXT(
			...
			"Keys: Standard UE key names or aliases. Aliases: R3/L3 (stick click), R1/L1/RB/LB (shoulder), R2/L2/RT/LT (trigger), R2Axis/L2Axis/RTAxis/LTAxis (trigger axis), Cross/Circle/Square/Triangle, FaceA/FaceB/FaceX/FaceY, LeftStick2D/RightStick2D/LeftStickX/LeftStickY/RightStickX/RightStickY, DPadUp/DPadDown/DPadLeft/DPadRight, Start/Select/Options/Share/Menu/View, LMB/RMB/MMB. Full UE names also work (e.g., Gamepad_FaceButton_Bottom).\n\n"
		...
		Info.Parameters = {
			...
			FMCPToolParameter(TEXT("key"), TEXT("string"),
				TEXT("Key name or alias (e.g., 'SpaceBar', 'R3', 'Cross', 'LMB', 'Gamepad_FaceButton_Bottom')"), false),
